  ...
  return (
    ...
    >
      ...
      >
        ...
        <ThreadPrimitive.ViewportFooter className="aui-thread-viewport-footer sticky bottom-0 mx-auto mt-auto flex w-full max-w-(--thread-max-width) flex-col gap-4 overflow-visible pb-3">
...
const MessageError: FC = () => {
  return (
    <MessagePrimitive.Error>
      <ErrorPrimitive.Root className="aui-message-error-root mt-2 rounded-xl border border-destructive bg-destructive/10 p-3 text-destructive text-sm dark:bg-destructive/5 dark:text-red-200">
...
const AssistantMessage: FC = () => {
  return (
    <MessagePrimitive.Root
      ...
      data-role="assistant"
    >
      <div className="aui-assistant-message-content wrap-break-word px-2 text-[13px] text-foreground leading-relaxed">
      ...
      <div className="aui-assistant-message-footer mt-0.5 ml-2 flex">
        <BranchPicker />
        <AssistantActionBar />
      </div>
    </MessagePrimitive.Root>
  ...
  return (
    ...
    >
      ...
      <div className="aui-user-message-content-wrapper relative col-start-2 min-w-0">
        <div className="aui-user-message-content wrap-break-word rounded-2xl bg-muted px-3 py-2 text-[13px] text-foreground">
          <MessagePrimitive.Parts />
        </div>
...
const EditComposer: FC = () => {
  return (
    <MessagePrimitive.Root className="aui-edit-composer-wrapper mx-auto flex w-full max-w-(--thread-max-width) flex-col px-2 py-3">
      <ComposerPrimitive.Root className="aui-edit-composer-root ml-auto flex w-full max-w-[85%] flex-col rounded-3xl bg-card">
        <ComposerPrimitive.Input
